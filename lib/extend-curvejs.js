...
exports.motion = exports.SmoothCurve = exports.Curve = exports.Stage = undefined;
...
var _smoothCurve = require('./smoothCurve');

var _smoothCurve2 = _interopRequireDefault(_smoothCurve);
...
var SmoothCurve = function (_CsmoothCurve) {
    (0, _inherits3.default)(SmoothCurve, _CsmoothCurve);

    function SmoothCurve(option) {
        (0, _classCallCheck3.default)(this, SmoothCurve);
        return (0, _possibleConstructorReturn3.default)(this, (SmoothCurve.__proto__ || (0, _getPrototypeOf2.default)(SmoothCurve)).call(this, option));
    }
    ...
    (0, _createClass3.default)(SmoothCurve, [{
        ...
        value: function _initVision() {
            ...
            var curveCount = this.disableVision ? 1 : this.visionMax;

            for (var i = 0; i < curveCount; i++) {
                var curve = new _smoothCurve2.default();
                curve.attr({
                    color: this.color,
                    pos: [this.x, this.y]
                });
            ...
            for (var _i = 0; _i < visionCount; _i++) {
                this.tick(true);
            }
        }
    }, {
        ...
        value: function draw(layer) {
            ...
            var lastIndex = this.visionGroup.children.length - 1;
            this.visionGroup.children.forEach(function (va, index) {
                var path = _this6.vision[index];
                var opacity = index === lastIndex ? 1 : index / _this6.visionMax * _this6.visionAlpha;
                va.attr({
                    opacity: opacity,
                    d: path
                });
